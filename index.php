...
<section class="templates-section">
  ...
  <div class="tmpl-tabs">
    <span class="is-active">ATS Friendly</span>
  ...
  <div class="tmpl-grid">
    <div class="tmpl-card blue reveal">
      <div class="tmpl-preview">
        <div class="bar head"></div>
        <div class="accent-block"></div>
        <div class="bar w90"></div><div class="bar w70"></div><div class="bar w50"></div>
      </div>
      <div class="tmpl-name">Blue · Professional</div>
    </div>
    <div class="tmpl-card green reveal">
      <div class="tmpl-preview">
        <div class="bar head"></div>
        <div class="accent-block"></div>
        <div class="bar w90"></div><div class="bar w70"></div><div class="bar w50"></div>
      </div>
      <div class="tmpl-name">Green · Modern</div>
    </div>
    <div class="tmpl-card white reveal">
      <div class="tmpl-preview">
        <div class="bar head"></div>
        <div class="accent-block"></div>
        <div class="bar w90"></div><div class="bar w70"></div><div class="bar w50"></div>
      </div>
      <div class="tmpl-name">White · Elegant</div>
    </div>
    <div class="tmpl-card black reveal">
      <div class="tmpl-preview">
        <div class="bar head"></div>
        <div class="accent-block"></div>
        <div class="bar w90"></div><div class="bar w70"></div><div class="bar w50"></div>
      </div>
      <div class="tmpl-name">Black · Sophisticated</div>
    </div>
    <div class="tmpl-card red reveal">
      <div class="tmpl-preview">
        <div class="bar head"></div>
        <div class="accent-block"></div>
        <div class="bar w90"></div><div class="bar w70"></div><div class="bar w50"></div>
      </div>
      <div class="tmpl-name">Red · Bold</div>
    </div>
  </div>
</section>
